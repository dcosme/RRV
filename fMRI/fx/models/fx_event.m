...
matlabbatch{2}.spm.util.exp_frames.files = {'/projects/sanlab/shared/RRV/bids_data/derivatives/fmriprep/sub-RRV001/ses-wave1/func/s6_sub-RRV001_ses-wave1_task-CR_acq-2_bold_space-MNI152NLin2009cAsym_preproc.nii,1'};
matlabbatch{2}.spm.util.exp_frames.frames = Inf;
matlabbatch{3}.spm.stats.fmri_spec.dir = {'/projects/sanlab/shared/RRV/nonbids_data/fMRI/fx/models/event/sub-RRV001'};
...
matlabbatch{3}.spm.stats.fmri_spec.sess(1).multi = {'/projects/sanlab/shared/RRV/RRV_scripts/fMRI/fx/multiconds/event/RRV001_CR_run1.mat'};
matlabbatch{3}.spm.stats.fmri_spec.sess(1).regress = struct('name', {}, 'val', {});
matlabbatch{3}.spm.stats.fmri_spec.sess(1).multi_reg = {'/projects/sanlab/shared/RRV/RRV_scripts/fMRI/fx/motion/auto-motion-fmriprep/rp_txt/rp_RRV001_1_CR_1.txt'};
...
matlabbatch{3}.spm.stats.fmri_spec.sess(2).multi = {'/projects/sanlab/shared/RRV/RRV_scripts/fMRI/fx/multiconds/event/RRV001_CR_run2.mat'};
matlabbatch{3}.spm.stats.fmri_spec.sess(2).regress = struct('name', {}, 'val', {});
matlabbatch{3}.spm.stats.fmri_spec.sess(2).multi_reg = {'/projects/sanlab/shared/RRV/RRV_scripts/fMRI/fx/motion/auto-motion-fmriprep/rp_txt/rp_RRV001_1_CR_2.txt'};
...
matlabbatch{3}.spm.stats.fmri_spec.mask = {'/projects/sanlab/shared/spm12/canonical/MNI152lin_T1_2mm_brain_mask.nii,1'};
